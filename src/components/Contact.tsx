      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Looking for a driven graduate who's comfortable in enterprise environments and eager to write real software? Let's talk.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="glass-card rounded-2xl p-8">
              ...
              <p className="text-slate-400 mb-4">
                I'm actively applying for graduate software engineering, cloud/DevOps, data, and cybersecurity roles. 
                Happy to discuss any opportunity — usually respond within 24 hours.
              </p>
          ...
          >
            ...
            {formSubmitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-lg font-semibold mb-2">Message Ready!</p>
                <p className="text-slate-400 text-sm">
                  Your email client will open. Just click send to complete.
                </p>
              </div>
            ) : (
