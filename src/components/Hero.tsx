...
export default function Hero() {
  ...
  return (
    <>
      ...
      <section id="home" className={`min-h-screen flex items-center justify-center relative overflow-hidden pt-20 ${!isDark ? 'light-mode' : ''}`}>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div>
              <div className="text-3xl font-bold text-pink-400">{downloads}</div>
              <div className="text-slate-500 text-sm">CV Downloads</div>
            </div>
          </motion.div>
        </div>
      </section>
