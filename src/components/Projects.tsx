...
import { ExternalLink, Github, Shield, Lock, Wifi, Plane, Kanban, BarChart } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Selected personal projects spanning cryptography, cloud security, network tooling, and full-stack development.
          </p>
        </motion.div>
