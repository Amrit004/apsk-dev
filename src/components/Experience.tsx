  ...
  return (
    <section id="experience" className="py-16 bg-slate-900">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-sm text-slate-500 mb-8">Employed by Manpower (Zoom IT) – April 2022 to April 2026</p>
        <div className="space-y-6">
          {EXPERIENCE.map((exp) => (
            <div key={exp.company} className="card">
              <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                <div><div className="flex items-center gap-2 mb-1"><Building2 className="w-5 h-5 text-blue-400" /><h3 className="text-lg font-bold text-white">{exp.company}</h3></div><p className="text-slate-300">{exp.role}</p></div>
